...
public class TestIterator2 {
	...
	//	intItr.remove();//IllegalStateException
	...
	//	System.out.println(intItr.next());//NoSuchElementException
		System.out.println(intList.get(intList.size()));//IndexOutOfBoundException
